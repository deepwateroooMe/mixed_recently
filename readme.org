...
* Contents
- *.zshrc* reference for *Window 10 WSL Ubuntu terminator zsh;*
- *config* for  *Window 10 WSL Ubuntu terminator configuration;*
- *wubi_**: for Rime windows Chinese Wubi input method configurations. 
- all above use as reference so that when change laptop, new environment can be set up as soon as possible. 