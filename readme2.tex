...
\section{自己个人对这件事的总结}
\label{sec-1}
\subsection{一个极端无耻贱渣女：在它的冷血极端暴力之后，它永远欠别人一个官方正式道歉}
\label{sec-1-1}
...
爱表哥，爱生活！！！
\end{minted}
\subsection{婚礼 + 结婚证: 活宝妹没有同亲爱的表哥的结婚证，活宝妹就永远也不会再离开亲爱的表哥所在的这个小镇！！！}
\label{sec-1-3}
\begin{minted}[fontsize=\scriptsize,linenos=false]{text}
亲爱的表哥
