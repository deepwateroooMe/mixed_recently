...
\begin{itemize}
\item \textbf{I did NOT have the chance to learn nor correct myself behaviorly before the hearing (yet EVEN the most recent 2nd incidents occurred)}.
...
\end{itemize}
\item (Stalking protection order) \textbf{End (effective) date of 2099} is \textbf{way too much destroying (any retarded even any) normal person's life.} The law is supposed to help person's life NOT destroying any person. 
\begin{itemize}
\item As the appllant has been fully developped and having awareness of correcting herself, your honor, please help consider voidate the protection order, and allow chances of practicing normal person's daily life.
\end{itemize}
\end{itemize}
